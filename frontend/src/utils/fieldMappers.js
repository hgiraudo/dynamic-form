...
export const tipoDeTramiteMapper = (formData, fieldName) => {
  const result = {
...
export const usoDeFirmaMapper = (formData, fieldName) => {
  const result = {
...
export const representanteNombre1Mapper = (formData, fieldName) => {
...
export const representanteApellido1Mapper = (formData, fieldName) => {
  const mapped = { ...formData };
...
export const representanteEmail1Mapper = (formData, fieldName) => {
  const mapped = { ...formData };
...
export const representanteApellido2Mapper = (formData, fieldName) => {
  const mapped = { ...formData };
...
export const representanteNombre2Mapper = (formData, fieldName) => {
  const mapped = { ...formData };
...
export const representanteEmail2Mapper = (formData, fieldName) => {
  const mapped = { ...formData };
...
export const emailMapper = (formData, fieldName) => {
  if (!fieldName) return formData; // seguridad extra
  const newData = { ...formData };
  const index = fieldName.replace("CorreoElectronico", "");
