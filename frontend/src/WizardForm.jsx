...
function WizardForm() {
  ...
  const handleSign = async () => {
    try {
      ...
      const pdfResp = await fetch(appConfig.pdfTemplate);
      const pdfBlob = await pdfResp.blob();
      const pdfFile = new File([pdfBlob], appConfig.pdfFilename, {
    ...
    <div className="flex max-w-7xl mx-auto p-0 border rounded shadow-lg overflow-hidden h-[80vh]">
      ...
      <div className="w-80 bg-brand-primary flex flex-col text-blue-200 p-2 pl-4">
        <div className="p-6 text-center">
          <img src="/img/logo-white.svg" alt="Logo" className="h-12 mx-auto" />
        </div>
